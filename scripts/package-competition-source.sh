...
with ZipFile(archive) as zip_file:
    ...
    required = {
        ...
        prefix + "backend/core_business/api.py",
        prefix + "backend/core_business/auth.py",
        prefix + "backend/core_business/manuals.py",
        prefix + "backend/core_business/graph.py",
        prefix + "backend/core_business/work_orders.py",
        prefix + "backend/openapi/case-platform.openapi.yaml",
        prefix + "backend/presentation_store.py",
        prefix + "backend/data/presentation/manual_sources.json",
        prefix + "Docs/README.md",
        prefix + "Docs/competition-submission-core-business-enhancement-spec.md",
